...
/*
 * This class represents the rig that provides its values to the PFNN.
 * The results of the PFNN are applied to this rig.
 * The rig consists of 31 bones and is identical in design to the original rig.
 */
public class PFNNActor : MonoBehaviour {
	...
	*/
	...
	public class Bone {
		...
		public Bone(PFNNActor actor, Transform transform, int index) {
			Actor = actor;
			Transform = transform;
...
#if UNITY_EDITOR
	[CustomEditor(typeof(PFNNActor))]
	public class Actor_Editor : Editor {

		public PFNNActor Target;

		void Awake() {
			Target = (PFNNActor)target;
		}
